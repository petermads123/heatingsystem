...
The package's own `tests/test_pi_controller.py` predates this pipeline and is a fair second
reference, but the worked file below is the authority where they differ.
